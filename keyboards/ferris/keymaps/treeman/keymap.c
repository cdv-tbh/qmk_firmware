...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_NAV] = LAYOUT(
      ...
      KC_ENT,  xxxxxxx, xxxxxxx, KC_PGDN, KC_END,       xxxxxxx, WINALT,  xxxxxxx, xxxxxxx, xxxxxxx,
                                 _______, _______,      WNAV,    _______
    ),
    [_WIN] = LAYOUT(
      _______, TAB,     _______, _______, _______,     _______, _______, _______, _______, _______, 
      S_TAB,   _______, _______, _______, _______,     _______, _______, _______, _______, _______, 
      _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, 
                                 _______, _______,     _______, _______                                 
    ),
